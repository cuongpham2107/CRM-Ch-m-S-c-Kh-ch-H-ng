    ...
    <div class="navbar-top-left">
        <div class="brand-logo">
            <a href="{{ route('admin.dashboard.index') }}">
                {{-- <img src="{{ asset('vendor/webkul/admin/assets/images/logo.svg') }}" alt="{{ config('app.name') }}" style="clip-path: polygon(0 0, 40% 0, 40% 100%, 0% 100%);"/> --}}
                <h1 style="font-size: 21px; margin-bottom: 0; line-height: 2.2;">VNPT Nam Định</h1>
            </a>
        </div>
    </div>
